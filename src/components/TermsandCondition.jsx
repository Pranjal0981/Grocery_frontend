...
const TermsAndConditions = () => {
    return (
        <div className="container mx-auto p-6 bg-gray-50 rounded-lg shadow-md">
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">2. Eligibility</h2>
                <p className="text-gray-700 mb-4">To use our services, you must be at least 18 years old and capable of forming a legally binding contract. By using RGS Grocery, you represent and warrant that you meet these eligibility criteria.</p>
            </section>

            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">3. Account Registration</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">4. Orders and Payments</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">5. Delivery</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">6. Exchanges</h2>
                <p className="text-gray-700 mb-4">We do not accept returns of products. However, we offer exchanges for certain products within 24 to 48 hrs of delivery, provided the products are unopened, unused, and in their original packaging. Perishable goods and personal care items are non-exchangeable.</p>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">7. Product Information</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">8. Intellectual Property</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">9. Limitation of Liability</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-semibold text-indigo-700 mb-4">10. Governing Law</h2>
                <p className="text-gray-700">These Terms and Conditions are governed by and construed in accordance with the laws of [Your Country/State], without regard to its conflict of law principles. Any disputes arising under these Terms and Conditions shall be subject to the exclusive jurisdiction of the courts located in [Your Jurisdiction].</p>
            </section>
