        ...
        <div className="container mx-auto px-4 py-8 bg-gray-50 rounded-lg shadow-md">
            ...
            <div className="mb-8">
                ...
                <div className="mb-4">
                    ...
                    <p className="text-gray-700">Delivery Time: Within 3-5 business days</p>
                    <p className="text-gray-700">Delivery Fee: Free</p>
                </div>
                <div className="mb-4">
                    <h4 className="text-xl font-bold">Express Delivery</h4>
                    <p className="text-gray-700">Delivery Time: Within 24-48 hours</p>
                    <p className="text-gray-700">Delivery Fee: Free</p>
                </div>
                <div className="mb-4">
                    <h4 className="text-xl font-bold">Same-Day Delivery</h4>
                    <p className="text-gray-700">Delivery Time: Delivered on the same day for orders placed before 12 PM</p>
                    <p className="text-gray-700">Delivery Fee: Free</p>
                </div>
                <div className="mb-4">
                    <h4 className="text-xl font-bold">Scheduled Delivery</h4>
                    <p className="text-gray-700">Delivery Time: Choose a convenient delivery slot up to 7 days in advance</p>
                    <p className="text-gray-700">Delivery Fee: Free</p>
                </div>
            </div>

            <div className="mb-8">
                <h3 className="text-2xl font-bold mb-4 text-indigo-800">Delivery Areas</h3>
                <p className="text-gray-700">We currently deliver to the following areas:</p>
                <ul className="list-disc pl-6 text-gray-700">
                    <li>Minal Residency</li>
                    <li>Rohit Nagar</li>
                    <li>Gokuldham</li>
                    <li>Jhansi</li>
                ...
                <p className="text-gray-700 mt-2">If your area is not listed, please check back later as we are continually expanding our delivery zones.</p>
            </div>

            <div className="mb-8">
                <h3 className="text-2xl font-bold mb-4 text-indigo-800">Delivery Times</h3>
                <p className="text-gray-700">Deliveries are made between 8 AM and 8 PM, Monday to Saturday. No deliveries are made on Sundays and public holidays.</p>
            </div>
            ...
            <div className="mb-8">
                <h3 className="text-2xl font-bold mb-4 text-indigo-800">Contactless Delivery</h3>
                <p className="text-gray-700">To ensure safety during COVID-19, we offer contactless delivery. Our delivery personnel will leave your order at your doorstep and notify you via call or SMS.</p>
            </div>

            <div className="mb-8">
                <h3 className="text-2xl font-bold mb-4 text-indigo-800">Delivery Policies</h3>
                <div className="mb-4">
                    <h4 className="text-xl font-bold">Missed Delivery</h4>
                    <p className="text-gray-700">If you are not available at the time of delivery, our delivery team will attempt to contact you. A second attempt will be made at no extra charge. If the second attempt is also unsuccessful, you may be charged a re-delivery fee.</p>
                </div>
                <div className="mb-4">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-700">Phone: [Customer support number]</p>
                <p className="text-gray-700">Email: [Customer support email]</p>
                <p className="text-gray-700">Live Chat: Available on our website from 9 AM to 6 PM, Monday to Saturday.</p>
            </div>

            <p className="text-gray-700 text-center">Thank you for choosing [Your Grocery Site]. We strive to provide the best service and quality products to our valued customers.</p>
        </div>
    );
};
