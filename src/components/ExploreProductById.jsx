            ...
            {product && (
                <>
                    ...
                    <div className="md:border-l-2 md:border-red-200 md:pl-8">
                        ...
                        <p className="mb-4 text-lg font-medium text-gray-900">Main Price: <s>${product?.price}</s></p>
                        <p className="mb-4 text-lg font-medium text-gray-900">Discounted Price: ${product?.DiscountedPrice}</p>
